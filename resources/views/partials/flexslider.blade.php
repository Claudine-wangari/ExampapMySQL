<ul class="slides">
    <li class="overlay" style="background-image: url(img/strath1.jpg)">
        <div class="container">
            <div class="row">
    ...
    <li style="background-image: url(img/strath2.jpg)" class="overlay">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="probootstrap-slider-text text-center">
    ...
    <li style="background-image: url(img/strath3.jpg)" class="overlay">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="probootstrap-slider-text text-center">
