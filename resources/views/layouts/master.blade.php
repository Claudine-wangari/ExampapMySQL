...
<div class="probootstrap-page-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="probootstrap-flex-block">
                        ...
                        <div class="probootstrap-image probootstrap-animate" style="background-image: url(img/strath4.jpg)">
    ...
    <section class="probootstrap-section probootstrap-section-colored probootstrap-bg probootstrap-custom-heading probootstrap-tab-section" style="background-image: url(img/strath2.jpg)">
        <div class="container">
            <div class="row">
    ...
    <section class="probootstrap-section probootstrap-bg probootstrap-section-colored probootstrap-testimonial" style="background-image: url(img/strath4.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center section-heading probootstrap-animate">
